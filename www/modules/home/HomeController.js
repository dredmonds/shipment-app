app.controller('HomeController', function(HomeService, $scope, $state, $http, $ionicPopup, $ionicModal, $ionicLoading, $rootScope) {
	...
	function loadGeoChartMap(){
	  ...
	  function drawRegionsMap() {
	    ...
	    var chart = new google.visualization.GeoChart(document.getElementById('geoGlobalMap_div'));
